#!/bin/sh
#
# Manual GnuPG configurtion required!
# In file ~/.gnupg/gpg-agent.conf set
#
#   pinentry-program ~/bin/pinentry-auto.sh
#
# the make the agent reload its configuration:
#
#   pkill -HUP gpg-agent
#
#
